...
These time series are the result of the registration, segmentation, and extraction preprocessing steps. There are two .csv files for each organoid: pre- and post-puncture.
